# A simple arena fighting game that allows the player to set their name,
# class, and loops through a combat scenario with an enemy. The combat
# continues automatically until either the player or the enemy is defeated.
import random
...
while is_fighting:
    ...
    # Check initiative based on random dex roll to determine attack order
